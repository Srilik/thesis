                ...
                <form @submit.prevent="onSave">
                    <div class="flex flex-col gap-2 lg:flex-row">
                        <div class="flex flex-col w-full">
                            <label class="text">Thesis_No</label>
                        ...
                        <div class="flex flex-col w-full">
                            <label class="text">Thesis_Group</label>
                    ...
                    <div class="flex flex-col gap-2 lg:flex-row">
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input v-model="form.Title" class="textarea textarea-primary w-full"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input v-model="form.Title_Khmer" class="textarea textarea-primary w-full"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input v-model="form.Objective" class="textarea textarea-primary w-full"
                    ...
                    <div class="flex flex-col gap-2 lg:flex-row">
                        <div class="flex flex-col w-full">
                            ...
                            <input v-model="form.Objective_Khmer" class="textarea textarea-primary w-full"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input v-model="form.Summary" class="textarea textarea-primary w-full"
                        ...
                        <div class="flex flex-col w-full">
                            <label class="date">Submit_Date</label>
                        ...
                        <div class="flex flex-col w-full">
                            <label class="date">Defend_Date</label>
                    ...
                    <div class="flex flex-col gap-2 lg:flex-row">
                        <div class="flex flex-col w-full">
                            <label class="text">Book_Score</label>
                            <input v-model.number="form.Book_Score" class="input input-primary w-full"
                        ...
                        <div class="flex flex-col w-full">
                            <label class="time">Defend_time</label>
                        ...
                        <div class="flex flex-col w-full">
                            <label class="date">Submit_book</label>
