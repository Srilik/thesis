...
<template>
    <App>
        <div class="p-3">
            ...
            <div class="mt-4">
                <div class="flex justify-between p-2 bg-base-100 rounded-xl">
                    <Link
                        :href="route('thesis.index')"
                        class="flex items-center btn btn-info"
                    >
                        <MoveLeft class="w-5 h-5 mr-1" />
                        Back
                    </Link>
                    <h2
                        class="flex justify-between p-2 text-2xl font-bold uppercase"
                    >
                        Create a Thesis
                    </h2>
                    <button type="submit" class="btn btn-info" @click="onSave">
            ...
            <div class="p-4 mt-4 bg-base-100 rounded-xl">
                ...
                <form @submit.prevent="onSave">
                    <div class="flex flex-col gap-6 mb-4 lg:flex-row">
                        <div class="flex flex-col w-full">
                            <label class="label">Thesis_No</label>
                            <input
                                v-model.number="form.Thesis_No"
                                type="number"
                                class="w-full input input-info"
                                :class="{
                                    'input-error': form.errors.Thesis_No,
                                }"
                            />
                            <div
                                class="text-sm text-red-500"
                                v-if="form.errors.Thesis_No"
                            >
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input
                                v-model.number="form.Thesis_Group"
                                type="number"
                                class="w-full input input-info"
                                :class="{
                                    'input-error': form.errors.Thesis_Group,
                                }"
                            />
                            <div
                                class="text-sm text-red-500"
                                v-if="form.errors.Thesis_Group"
                            >
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <!-- <input v-model="form.Academic_Year" class="w-full input input-info"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <!-- <input v-model="form.Department" class="w-full input input-info"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <!-- <input v-model="form.Major" class="w-full input input-info"
                    ...
                    <div class="flex flex-col gap-2 lg:flex-row">
                        <div class="flex flex-col w-full">
                            ...
                            <!-- <input v-model="form.Year" class="w-full input input-info"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <!-- <input v-model="form.Session" class="w-full input input-info"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input
                                v-model="form.Organizaition"
                                type="text"
                                class="w-full input input-info"
                                :class="{
                                    'input-error': form.errors.Organizaition,
                                }"
                            />
                            <div
                                class="text-sm text-red-500"
                                v-if="form.errors.Organizaition"
                            >
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <!-- <input v-model="form.Organization_Type" class="w-full input input-info"
                            ...
                            >
                                <option value="">
                                    Select a Organization Type
                                </option>
                                <option value="Government">Government</option>
                                <option value="Private">Private</option>
                                <option value="Non Government(NGO)">
                                    Non Government(NGO)
                                </option>
                            ...
                            <div
                                class="text-sm text-red-500"
                                v-if="form.errors.Organization_Type"
                            >
                    ...
                    <div class="flex flex-col gap-2 mt-4 lg:flex-row">
                        <div class="flex flex-col w-full">
                            ...
                            <textarea
                                v-model="form.Title"
                                class="w-full h-full input input-info"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <textarea
                                v-model="form.Title_Khmer"
                                class="w-full h-full input input-info"
                                :class="{
                                    'input-error': form.errors.Title_Khmer,
                                }"
                            >
                            </textarea>
                            <div
                                class="text-sm text-red-500"
                                v-if="form.errors.Title_Khmer"
                            >
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <textarea
                                ...
                                class="w-full h-full input input-info"
                                :class="{
                                    'input-error': form.errors.Objective,
                                }"
                            >
                            </textarea>
                            <div
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <textarea
                                v-model="form.Objective_Khmer"
                                class="w-full h-full input input-info"
                                :class="{
                                    'input-error': form.errors.Objective_Khmer,
                                }"
                            >
                            </textarea>
                            <div
                                class="text-sm text-red-500"
                                v-if="form.errors.Objective_Khmer"
                            >
                    ...
                    <div class="flex flex-col gap-2 mt-4 lg:flex-row">
                        <div class="flex flex-col w-full">
                            ...
                            <!-- <input v-model="form.Location" class="w-full input input-info"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input
                                v-model.number="form.Organization_Phone"
                                type="number"
                                class="w-full input input-info"
                                :class="{
                                    'input-error':
                            ...
                            <div
                                class="text-sm text-red-500"
                                v-if="form.errors.Organization_Phone"
                            >
                                {{ form.errors.Organization_Phone }}
                            </div>
                        </div>
                        <div class="flex flex-col w-full">
                            ...
                            <input
                                ...
                                class="w-full input input-info"
                                :class="{
                                    'input-error': form.errors.Submit_Date,
                                }"
                            />
                            <div
                                class="text-sm text-red-500"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <!-- <input v-model="form.Teacher_id" class="w-full input input-info"
                                :class="{ 'input-error': form.errors.Teacher_id }" /> -->
                            <select
                                v-model="form.Teacher_id"
                                class="w-full input input-info"
                                :class="{
                                    'input-error': form.errors.Teacher_id,
                                }"
                            >
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input
                                v-model="form.Defend_Date"
                                type="date"
                                class="w-full input input-info"
                                :class="{
                                    'input-error': form.errors.Defend_Date,
                                }"
                            />
                            <div
                                class="text-sm text-red-500"
                                v-if="form.errors.Defend_Date"
                            >
                    ...
                    <div class="flex flex-col gap-2 mt-4 lg:flex-row">
                        <div class="flex flex-col w-full">
                            ...
                            <input
                                v-model.number="form.Book_Score"
                                type="number"
                                class="w-full input input-info"
                                :class="{
                                    'input-error': form.errors.Book_Score,
                                }"
                            />
                            <div
                                class="text-sm text-red-500"
                                v-if="form.errors.Book_Score"
                            >
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input
                                v-model="form.Defend_time"
                                type="time"
                                class="w-full input input-info"
                                :class="{
                                    'input-error': form.errors.Defend_time,
                                }"
                            />
                            <div
                                class="text-sm text-red-500"
                                v-if="form.errors.Defend_time"
                            >
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input
                                v-model="form.Submit_book"
                                type="datetime-local"
                                class="w-full input input-info"
                                :class="{
                                    'input-error': form.errors.Submit_book,
                                }"
                            />
                            <div
                                class="text-sm text-red-500"
                                v-if="form.errors.Submit_book"
                            >
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <!-- <input v-model="form.Building" class="w-full input input-info"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <!-- <input v-model="form.Room" class="w-full input input-info"
